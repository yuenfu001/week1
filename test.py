Total_class = int(input("Enter Total Number in Class here: "))
...
dict1 ={}
for a in range(1,Total_class+1):
    keys = input("Enter  Student {}'s name here: \n".format(a))
    values = float(input("Enter Student {}'s scores here: \n".format(a)))
    dict1[keys] = values
